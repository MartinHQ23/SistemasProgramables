...
**CIRCUITO ENSAMBLADO**
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.2_Circuito.png" width= height=>
</p>
...
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.2_Codigo.png" width= height=>
</p>
...
**Funcionamiento**
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.2_Circuito2.png" width= height=>
</p>

**Resultado Observado**
```
Cada vez que se presionaba el boton, el estado cambiaria de 0 a 1, esto durante el tiempo que dura el boton presionado, una vez que se suelta el boton vuelve a su estado 0 y envia la informacion al puerto 9600 para guardarla, dependiendo del tiempo asignado.
```
