...
**CIRCUITO ENSAMBLADO**
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.1_Circuito.png" width= height=>
</p>
...
**Codigo**
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.1_Codigo.png" width=  height= >
</p>
...
**Resultado Observado**
```
Dependiendo del tiempo que se le de, este enviara señal alta al Pin 13, como en este caso, es cada segundo, el siguiente segundo la señal baja, haciendo asi que el LED encienda cuando recibe señal alta y se apague cuando recibe señal Baja.
```
4. Inserte aquí las imágenes que considere como evidencias para demostrar el resultado obtenido.

**Funcionamiento**
<p align="center">
    <img alt="SalidaDigital" src="../img/C3.1_Circuito2.png" width= height=>
</p>
