...
<p align="center">
    <img alt="Logo" src="../img/C2.2_Cuadro.drawio.png" width= height=>
</p>
 ...
 **RESPUESTA** :white_check_mark: 
 ```
Controlar la accion de los relevadores los cuales permiten otorgar los 24 V a las electrovalvulas.
  ```

  Que otros componentes electrónicos observa en el video?
 ```
Valvulas, Cilindros neumaticos, Reveladores, Arduino, Cilindro de doble efecto.
  ```
 ...
 **RESPUESTA** :white_check_mark: 
 ```
Se utilizaron Motores para el movimiento de la boquilla en los 3 Ejes de movimiento, para el enfriamento de la boquilla, se utilizo un ventilador, para expulsar el filamento del extrusor cuando este listo y un termistor para detectar la temperatura en los filamentos de plastico cuando estos se calientan.
  ```
### :bomb: Rubrica
